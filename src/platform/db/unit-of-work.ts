...
/**
 * Runs a unit of work inside a single database transaction. Lets an application
 * service compose several repository writes atomically without depending on the
